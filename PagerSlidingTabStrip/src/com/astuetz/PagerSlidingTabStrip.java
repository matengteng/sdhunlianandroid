...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int selectedPosition = 0;//选中后的位置
	private float currentPositionOffset = 0f;

	private Paint rectPaint;
	private Paint dividerPaint;

	private int indicatorColor = 0xFF1f50ff;//选中后滑动条的颜色-蓝色
	...
	private int tabTextSize = 40;         //选中前的字体大小
	private int tabTextColor = 0xFF666666; //选中前的颜色-黑色
	private int selectedTabTextSize = 40;    //选中后的字体大小
	private int selectedTabTextColor = 0xffd33e87;//选中后的颜色-蓝色

	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.SANS_SERIF.getStyle();
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (i == selectedPosition) {
					...
					tab.setTextSize(TypedValue.COMPLEX_UNIT_SP, selectedTabTextSize);
				}
			}
		}
