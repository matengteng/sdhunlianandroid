 ...
 * ----------“我关注的”适配器----------
 */
public class MyMineAttentionAdapter extends BaseAdapter {


    public MyMineAttentionAdapter(Context context, DataProvider provider) {
    ...
    private class ViewHolder{
        ...
        private TextView  tv_time_recomment_item;//时间
    }
}
